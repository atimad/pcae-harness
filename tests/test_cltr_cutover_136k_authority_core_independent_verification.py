...
# Updated by Phase 136N (14/15) and Phase 136P (16/17): these counts now
...
def test_136k_no_group4plus_schema_file_introduced_since_136l_baseline():
    ...
    # again by Phase 136N (Group 4), again by Phase 136P (Group 5), and
    # again by Phase 136R: contract Group 8 is now the legitimate current
