...
def test_48_no_contract_change() -> None:
  ...
  # changed; no test renamed/removed/disabled.
    assert set(git("diff", "--name-only", V, "--", "docs/contracts").split()) <= {'docs/contracts/HPAC_PRODUCTION_PROTECTED_ADMIN_WRITER_ANCHOR_CONTRACT.md', 'docs/contracts/HPAC_PAWA_PROTECTED_HELPER_PROTOCOL_CONTRACT.md', 'docs/contracts/HPAC_PROTECTED_PRESENTATION_AUTHORITY_CONTRACT.md'}
