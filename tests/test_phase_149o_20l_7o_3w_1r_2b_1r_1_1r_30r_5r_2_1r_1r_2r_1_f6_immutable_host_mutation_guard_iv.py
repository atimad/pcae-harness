...
def test_48_no_contract_change() -> None:
  ...
  # (HPAC-PAWA-REQ-217 discipline).
    assert set(git("diff", "--name-only", V, "--", "docs/contracts").split()) <= {'docs/contracts/HPAC_PRODUCTION_PROTECTED_ADMIN_WRITER_ANCHOR_CONTRACT.md', 'docs/contracts/HPAC_PAWA_PROTECTED_HELPER_PROTOCOL_CONTRACT.md'}
