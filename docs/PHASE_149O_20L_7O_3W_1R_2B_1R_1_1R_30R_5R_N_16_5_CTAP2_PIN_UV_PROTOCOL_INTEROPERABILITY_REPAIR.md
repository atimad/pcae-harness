...
| `.1R.30R.4R.1::test_03_rhamp_and_hpac_byte_unchanged_since_r4r`, `::test_72_rhamp_fido2_modules_are_byte_unchanged` | `git diff a727dbf4 HEAD` byte-unchanged guards over the RHAMP-FIDO2 modules. `hpac_rhamp_ctap2.py` is pinned to the `.1R.30R.4R.1` finalized head `5b6b4013`; the other five RHAMP-FIDO2 modules and `docs/contracts` stay byte-unchanged at HEAD. |
