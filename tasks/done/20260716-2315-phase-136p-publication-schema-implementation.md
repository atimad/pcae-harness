...
20260716-2315-phase-136p-publication-schema-implementation
...
Implement CLTR-CUTOVER-EXECUTABLE-SCHEMAS-001 v1.0 Implementation Group 5 (PublicationAttempt, PublicationEvidence) executable schemas, manifest entries, third cas_expectation embedding site, fixtures, and focused tests, per the frozen contract's own Sec.46 grouping (not the task prompt's expected ConcurrencyConflict-inclusive inventory).
...
2026-07-16T23:15:59.738048+02:00
